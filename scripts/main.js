 ...
 */
"use strict";
var gtris_version = '1.1.5474 Online Test Alpha, Release O_01';
var syncTime = 0;
var StartTime = 0
var syncFrame = 0;
var actualFrame = 0;
...
var settingsList = {
	...
	NonIterable: {
		Character: ['No Character', 'EricLenovo', 'Betelgeuse Abbygaile', 'Sun Gabbryielle', 'Pikumon10', 'Forest', 'Mars', 'Flotalendy', 'ElishDimensions', 'Evelyn', 'Gahmff', 'RubyStudios', 'Mia', 'Dominic Zi', 'Epicman33456', "Lunar Estelle", "Misty Firefox", "Its Aina Gacha", "EdgeBlackSword", "RedBot", "Nyan Yoshi"],
	},
	Other: {
...
function P_UPDATE() {
	...
	if (!isReplay && server.isOnline && server.isRunning && frame % 5 === 0) {
		...
		let plen = ml.size;
		//wr.u8(plen);
		wr.u8(gachamino.index !== 'reset' ? gachamino.index : 0);
		wr.u8(gachamino.pos);
		
		wr.i8(gachamino.x); //1byte
		wr.i8(Math.max(0, gachamino.y)); //1byte
