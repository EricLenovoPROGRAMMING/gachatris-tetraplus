...
function RESIZE() {
 ...
 docId('tSpin').style.fontSize = `${cellSize*0.5*tetrionSize}px`
 docId('regular').style.fontSize = `${cellSize*0.75*tetrionSize}px`
 docId('B2B').style.fontSize = `${cellSize*0.5*tetrionSize}px`
 docId('tSpin').style.height = `${cellSize*0.5*tetrionSize}px`
 docId('regular').style.height = `${cellSize*0.75*tetrionSize}px`
 docId('B2B').style.height = `${cellSize*0.5*tetrionSize}px`
 docId('REN').style.height = `${cellSize*1.3*tetrionSize}px`
 docId('REN').style.fontSize = `${cellSize*1.3*tetrionSize}px`
 ...
 for (var e of resultText)
  e.style.fontSize = `${cellSize*3*tetrionSize}px`
 ...
 playField.style.height = frenzyField.style.height = frenzyColor.style.height = `${_canvasses.field.height*tetrionSize}px`
 playField.style.width = frenzyField.style.width = frenzyColor.style.width = `${_canvasses.field.width*tetrionSize}px`
...

 {
  ...
  playField2.style.height = frenzyField2.style.height = frenzyColor2.style.height = `${_canvasses.field2.height*tetrionSize}px`
  playField2.style.width = frenzyField2.style.width = frenzyColor2.style.width = `${_canvasses.field2.width*tetrionSize}px`
  ...
  docId('tSpin2').style.fontSize = `${cellSize*0.5*tetrionSize}px`
  docId('regular2').style.fontSize = `${cellSize*0.75*tetrionSize}px`
  docId('B2B2').style.fontSize = `${cellSize*0.5*tetrionSize}px`
  docId('tSpin2').style.height = `${cellSize*0.5*tetrionSize}px`
  docId('regular2').style.height = `${cellSize*0.75*tetrionSize}px`
  docId('B2B2').style.height = `${cellSize*0.5*tetrionSize}px`
  docId('REN2').style.height = `${cellSize*1.3*tetrionSize}px`
  docId('REN2').style.fontSize = `${cellSize*1.3*tetrionSize}px`
