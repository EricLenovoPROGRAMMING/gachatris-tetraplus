...
if(movedMenuSessions.length!==0){
 docId('headerBackButton').style.display='block'
}else{
...
main[t].classList.remove('char-ACTIVE')
 ...
 docId("characterImage").src=`characters/${settingsList.NonIterable.Character[selectedSettings.NonIterable.Character]}/icon.png`
 $iH('characterName', settingsList.NonIterable.Character[selectedSettings.NonIterable.Character])
